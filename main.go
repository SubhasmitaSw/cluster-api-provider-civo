...
import (
	...
	infrastructurev1alpha1 "github.com/SubhasmitaSw/cluster-api-provider-civo/api/v1alpha1"
	"github.com/SubhasmitaSw/cluster-api-provider-civo/controllers"
...
func main() {
	...
	mgr, err := ctrl.NewManager(ctrl.GetConfigOrDie(), ctrl.Options{
		...
		LeaderElectionID:       "e9c1dc59.cluster.x-k8s.io",
