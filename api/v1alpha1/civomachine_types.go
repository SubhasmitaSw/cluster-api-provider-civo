...
type CivoMachine struct {
	metav1.TypeMeta   `json:",inline"`
	metav1.ObjectMeta `json:"metadata,omitempty"`

	Spec   CivoMachineSpec   `json:"spec,omitempty"`
	Status CivoMachineStatus `json:"status,omitempty"`
}

//+kubebuilder:object:root=true

// CivoMachineList contains a list of CivoMachine
type CivoMachineList struct {
	metav1.TypeMeta `json:",inline"`
	metav1.ListMeta `json:"metadata,omitempty"`
	Items           []CivoMachine `json:"items"`
}

func init() {
	SchemeBuilder.Register(&CivoMachine{}, &CivoMachineList{})
}
